...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Code Titans" },
      { name: "description", content: "Code Titans is a Cupertino-based non-profit empowering youth through computer science education." },
      { name: "author", content: "Code Titans" },
