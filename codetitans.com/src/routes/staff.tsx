                ...
                <div className="h-48 w-48 rounded-full border-4 border-[#000080] bg-[#000080]/20 flex items-center justify-center overflow-hidden">
                  {member.image ? (
                    <img
                      src={member.image}
                      alt={member.name}
                      className={`h-full w-full object-cover ${member.name === "Palash Agrawal" ? "object-[30%_20%] scale-125" : member.name === "Shreeansh Bharadwaj" ? "object-[50%_25%] scale-110" : member.name === "Minjae Kim" ? "object-[50%_15%]" : ""}`}
                    />
                  ) : (
